...
response = requests.post(f'{url}/main/dd/org/saveUser?sysappid={sysAppId}', cookies=cookies, headers=headers, data=data)
...
# response = requests.post(f'{url}/main/dd/org/exportOrg?syscorpid=123456&sysappid={sysAppId}', cookies=cookies, headers=headers, data=data)
